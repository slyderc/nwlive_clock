...
> **Fork Notice:** This is a fork of the original [OnAirScreen](https://github.com/saschaludwig/OnAirScreen) project by Sascha Ludwig / AstraStudio. The original project provides an excellent foundation for broadcast studio signaling. This fork contains modifications for specific use cases. Please visit the original repository to support the original author.
